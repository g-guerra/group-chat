...
/*
    This function is responsible for the server socket creation and initialization
*/
int init_default_socket( int* fd_socket, sockaddr_in_t socket_addr){
    ...
    *fd_socket = socket(PF_INET, SOCK_STREAM, 0);
    ...
    if(bind(*fd_socket, (struct sockaddr*)&socket_addr, sizeof(socket_addr)) != 0){
...
int main(int arg, char* args[]){
    ...
    while (1)
    {
        ...
        int fd_new_socket = accept(fd_srv, (struct sockaddr*)&cli_addr, &addr_lenght);
